    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Connexion à ScriptVerse</h1>
          <p className="mt-1 text-sm text-gray-500">Accédez à vos cours et continuez votre apprentissage</p>
        </div>
        ...
        <p className="text-center text-xs text-gray-400">
          Démo MVP — cliquez &quot;Se connecter&quot; pour accéder au catalogue
        </p>
      </div>
    </div>
  );
