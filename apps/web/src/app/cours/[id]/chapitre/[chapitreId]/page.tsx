    ...
    <PageTransition>
      <div className="min-h-screen bg-gray-900 flex flex-col">
        ...
        <div className="flex flex-1 overflow-hidden">
          {/* Lesson sidebar */}
          <FadeIn direction="right" delay={0.1} className="hidden lg:flex flex-col w-72 shrink-0 border-r border-gray-700 overflow-y-auto">
          ...
          <main className="flex-1 overflow-y-auto bg-gray-50">
            ...
            <div className="bg-black aspect-video w-full max-h-[60vh] flex items-center justify-center">
              {lesson.url && isSafeVideoUrl(lesson.url) ? (
                <iframe
                  src={lesson.url}
                ...
                <div className="text-center space-y-3">
                  <p className="text-red-400 text-sm">Source vidéo non autorisée.</p>
                </div>
              ) : (
                <div className="text-center space-y-3">
